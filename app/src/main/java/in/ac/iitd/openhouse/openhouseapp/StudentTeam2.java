...
public class StudentTeam2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.student_team_fragment2, container, false);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < resArray.length(); i++) {
                                ...
                                if(i>=0){
                                    StudentCoordi student1 = new StudentCoordi(studentObject.getString("name"), studentObject.getString("email"), studentObject.getString("phone"), studentObject.getInt("image"));
