...
//
                            ...
                            for (int i = 0; i < resArray.length(); i++) {
                                ...
                                if(i>0){
                                    if(!heroObject.getString("event").equals(resArray.getJSONObject(i-1).getString("event"))){
                                        Hero hero1 = new Hero(heroObject.getString("type"), heroObject.getString("event"));
